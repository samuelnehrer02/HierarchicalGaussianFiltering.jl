"""
    premade_pomdp_transition_3level(config::Dict; verbose::Bool = true)

The pomdp transition 3 level HGF model, learns state transition probabilities between a set of n categorical states.
...
"""
function premade_pomdp_transition(config::Dict; verbose::Bool = true)
